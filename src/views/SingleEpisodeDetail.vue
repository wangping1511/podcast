  ...
  <div id="topDiv" class="pb-5">
    <div class="pt-15">
      ...
      <div class="flex flex-col items-center" :class="light === 1 ? 'text-white' : ''">
        ...
        <div class="flex items-center justify-center w-60 h-10 rounded-lg mt-4 dark:bg-[#161616] bg-[#E1E1E1] bg-opacity-80 text-primary">
          <p class="text-sm font-medium">播放</p>
        </div>
      </div>
    </div>
  </div>
...
onMounted(() => {
  ...
  if (img) {
    ...
    if (img.complete) {
      ...
      topDiv.style.setProperty('background-image', 'linear-gradient(' + colorHex +', #E1E1E1)')
    } else {
